...
class WeaponDisplayPluginOld {
    ...
    private static void HandleDisplayToggle() {
        if (WeaponDisplayComponentOld.InternalState.weaponDisplay != null) {
            if (WeaponDisplayComponentOld.InternalState.weaponDisplay.removeOriginalMFDContent) {
                WeaponDisplayComponentOld.InternalState.weaponDisplay.ToggleChildrenActiveState();
...
public class WeaponDisplayComponentOld : Module {
    public WeaponDisplayComponentOld( 
        Harmony instance) 
        : base(
            "WeaponDisplay", 
