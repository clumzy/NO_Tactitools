...
- **Target List sorting**: Sort your current target list
  - Uses long presses on the Next/Previous buttons
  - **Previous (long press)** -> Sort targets by name
  - **Next (long press)** -> Sort targets by distance
